...
@section('breadcrumb')
    @parent
    <li><a href="{{ route('topik.index') }}">Topik</a></li>
    <li>Topik</li>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading"><strong>Daftar Topik  </strong><div class="pull-right"><strong></strong></div></div>
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <table id="mytable" class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="text-center" width="30%">Tema</th>
                                        <th scope="col" class="text-center" width="30%">Topik</th>
                ...
                <form id="store" data-toggle="validator" method="POST">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select name="idtema" id="idtema" class="form-control" required>
                                <option value="">Pilih Tema</option>
                                @foreach($tema as $listtema)
                                    <option value="{{ $listtema->id }}">{{ $listtema->tema}}</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control topik" name="topik" placeholder="Topik" required>
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <form id="update">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="idtema">Tema</label>
                            <input type="text" class="form-control idtema" name="idtema" placeholder="Tema" required>
                        </div>
                        <div class="form-group">
                            <label for="topik">Topik</label>
                            <input type="text" class="form-control topik" name="topik" placeholder="Topik" required>
        ...
        $(function () {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        if (result.success) {
                            ...
                            $('.id').val(json.id);
                            $('.idtema').val(json.idtema);
                            $('.topik').val(json.topik);
            ...
            $(document).on('submit', '#modalAdd', function (e) {
                ...
                var data = {
                    ...
                    idtema: formData[0].value,
                    topik: formData[1].value,
            ...
            $(document).on('submit', '#modalEdit', function (e) {
                ...
                var data = {
                    '_token': $('input[name=_token]').val(),
                    idtema: formData[1].value,
                    topik: formData[2].value,
