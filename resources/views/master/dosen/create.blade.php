    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form role="form" method="POST" enctype="multipart/form-data" action="{{route('dosen.store')}}">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-footer">
                        ...
                        <div class="col col-md-5">
                            <div class="pull-right image"><img src="{{asset('public/images/user.png')}}" class="img-thumbnail  img-circle" alt="User Image" style="width:250px; height: 250px;"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 input-group input-group-sm">
                                <input id="nidn" type="text" class="form-control" name="nidn"placeholder="NIDN" required>
                                @if ($errors->has('nidn'))
                        ...
                        <div class="form-group{{ $errors->has('newpass') ? ' has-error' : '' }}">
                            ...
                            <div class="form-group">
                                <div class="col-md-9 input-group input-group-sm">
                                    <input type="password" class="form-control" placeholder="Tulis Password" name="newpass" id="newpass" value="{{ old('newpass') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('confirm') ? ' has-error' : '' }}">
                            ...
                            <div class="form-group">
                                <div class="col-md-9 input-group input-group-sm">
                                    <input type="password" class="form-control" placeholder="Tulis ulang password " name="confirm" id="confirm" value="{{ old('confirm') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('nip') ? ' has-error' : '' }}">
                            ...
                            <div class="form-group">
                                <div class="col-md-9 input-group input-group-sm">
                                    <input type="text" class="form-control" placeholder="NIP" name="nip" id="nip" value="{{ old('nip') ? old('nip') : (count($profil) ? $profil->nip : $dosen->nip) }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('sinta') ? ' has-error' : '' }}">
                            ...
                            <div class="form-group">
                                <div class="col-md-9 input-group input-group-sm">
                                    <input type="text" class="form-control" placeholder="ID Sinta" name="sinta" id="sinta" value="{{ old('sinta') ? old('sinta') : (count($profil) ? $profil->sinta : $dosen->sinta) }}" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('hindex') ? ' has-error' : '' }}">
                            ...
                            <div class="form-group">
                                <div class="col-md-9 input-group input-group-sm">
                                    <input type="text" class="form-control" placeholder="H-Index" name="hindex" id="hindex" value="{{ old('hindex') ? old('hindex') : (count($profil) ? $profil->hindex : $dosen->hindex) }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('profil') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3 input-group-sm">
                                 <input type="file" accept="image/png" name="profil" id="profil" class="form-control" style="margin-left: -15px; width: 240px" required>
