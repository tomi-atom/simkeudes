...
@section('breadcrumb')
    @parent
    <li><a href="{{ route('struktural.index') }}">Master</a></li>
    <li>Struktural</li>
                            ...
                            <div class="table-responsive">
                                <table id="mytable" class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="text-center" width="30%">Strukural</th>
                ...
                <form id="store" data-toggle="validator" method="POST">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control struktural" name="struktural" placeholder="Struktural" required>
                        </div>
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        if (result.success) {
                            ...
                            $('.id').val(json.id);
                            $('.struktural').val(json.struktural);
