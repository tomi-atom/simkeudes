...
@section('breadcrumb')
    @parent
    <li><a href="{{ route('mataanggaran.index') }}">Master</a></li>
    <li>Mata Angaran</li>
                            ...
                            <div class="table-responsive">
                                <table id="mytable" class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="text-center" width="30%">Batas</th>
        ...
        $(function () {
            ...
            $(document).on('submit', '#modalAdd', function (e) {
                ...
                var data = {
                    ...
                    jenis: formData[0].value,
                    batas: formData[1].value,
