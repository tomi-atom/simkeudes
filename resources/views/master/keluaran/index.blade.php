...
@section('breadcrumb')
    @parent
    <li><a href="{{ route('keluaran.index') }}">Master</a></li>
    <li>Keluaran</li>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><strong>Daftar Keluaran </strong><div class="pull-right"><strong></strong></div></div>
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table id="mytable" class="table">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="text-center" width="10%">Kategori</th>
                                    <th scope="col" class="text-center" width="30%">Jenis</th>
                                    <th scope="col" class="text-center" width="20%">Target</th>
                ...
                <form id="store" data-toggle="validator" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control jenis" name="jenis" placeholder="Jenis" required>
                        </div>
                        <div class="form-group">
                            <label for="target">Target</label>
                            <input type="text" class="form-control target" name="target" placeholder="Target" required>
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <form id="update">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="kategori">Kategori</label>
                            <input type="text" class="form-control kategori" name="kategori" placeholder="Kategori" required>
                        </div>
                        <div class="form-group">
                            <label for="jenis">Jenis</label>
                            <input type="text" class="form-control jenis" name="jenis" placeholder="Jenis" required>
