...
@section('breadcrumb')
    @parent
    <li><a href="{{ route('tema.index') }}">Master</a></li>
    <li>Tema</li>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading"><strong>Daftar Tema  </strong><div class="pull-right"><strong></strong></div></div>
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <table id="mytable" class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="text-center" width="20%">Skema</th>
                ...
                <form id="store" data-toggle="validator" method="POST">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="idskema">Skema</label>
                            <select name="idskema" id="idskema" class="form-control" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control tema" name="tema" placeholder="Tema" required>
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <form id="update">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="idskema">Skema</label>
                            <input type="text" class="form-control idskema" name="idskema" placeholder="Skema" required>
                        </div>
                        <div class="form-group">
                            <label for="tema">Tema</label>
                            <input type="text" class="form-control tema" name="tema" placeholder="Tema" required>
        ...
        $(function () {
            ...
            $(document).on('submit', '#modalAdd', function (e) {
                ...
                var data = {
                    ...
                    idskema: formData[0].value,
                    tema: formData[1].value,
            ...
            $(document).on('submit', '#modalEdit', function (e) {
                ...
                var data = {
                    '_token': $('input[name=_token]').val(),
                    idskema: formData[1].value,
                    tema: formData[2].value,
