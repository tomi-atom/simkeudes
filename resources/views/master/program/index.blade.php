...
@section('breadcrumb')
    @parent
    <li><a href="{{ route('program.index') }}">Master</a></li>
    <li>Program</li>
                            ...
                            <div class="table-responsive">
                                <table id="mytable" class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="text-center" width="20%">Kategori</th>
                                        <th scope="col" class="text-center" width="30%">Program</th>
                ...
                <form id="store" data-toggle="validator" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control program" name="program" placeholder="Program" required>
                        </div>
                        <div class="form-group">
