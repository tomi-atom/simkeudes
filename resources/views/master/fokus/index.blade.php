...
@section('breadcrumb')
    @parent
    <li><a href="{{ route('fokus.index') }}">Fokus</a></li>
    <li>Fokus</li>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading"><strong>Daftar Fokus  </strong><div class="pull-right"><strong></strong></div></div>
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <table id="mytable" class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="text-center" width="30%">Fokus</th>
                ...
                <form id="store" data-toggle="validator" method="POST">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control fokus" name="fokus" placeholder="Fokus" required>
                        </div>
                        <div class="form-group">
