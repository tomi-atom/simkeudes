...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="panel panel-default">
                    <div class="panel-heading"><strong>Program Pengabdian: {{$peneliti->universitas->pt}}</strong></div>
                        ...
                        <tbody {{ $no = 1 }}>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="POST" action="{{ route('perbaikanpengabdianng.proposal.index', base64_encode(mt_rand(1,9).($periode+2).'/'.mt_rand(1,9).($data->id+9))) }}">
                     ...
                     <table class="table table-condensed">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <button type="submit" class="btn btn-primary pull-right"><span class="ion ion-android-add-circle"></span> Tambah</button>
                                    </div>
                                </td>
                            </tr>
                             <tr>
