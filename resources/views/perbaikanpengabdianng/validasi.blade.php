                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <tbody id="accordionproposal" class="collapse table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-left"   colspan="6">&nbsp;&nbsp;&nbsp;Program Pengabdian: {{$proposal->program->program}}</td>
                                                <td class="text-center" colspan="2">
                                                    <div class="progress progress-xs">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-left"   colspan="6">&nbsp;&nbsp;&nbsp;Tema Pengabdian: {{$proposal->tema->tema}}</td>
                                                <td class="text-center" colspan="2">
                                                    <div class="progress progress-xs">
                                                        <div class="progress-bar progress-bar-success" style="width: 35%"></div>
                                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-left"   colspan="6">&nbsp;&nbsp;&nbsp;Topik Pengabdian: {{$proposal->topik->topik}}</td>
                                                <td class="text-center" colspan="2">
                                                    <div class="progress progress-xs">
                                                        <div class="progress-bar progress-bar-success" style="width: 35%"></div>
                                                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <tbody id="accordionanggaran" class="collapse table-bordered">
                                            ...
                                            <tr>
                                                <td class="text-right">4</td>
                                                <td class="text-left"   colspan="6">&nbsp;&nbsp;&nbsp;Belanja Perjalanan: {{$jln}}</td>
                                                <td class="text-center" colspan="2">
                                                    <div class="progress progress-xs">
                                            ...
                                            <tr>
                                                <td class="text-right">5</td>
                                                <td class="text-left"   colspan="6">&nbsp;&nbsp;&nbsp;Belanja Barang Non-Operasional: Rp {{$brg}}</td>
                                                <td class="text-center" colspan="2">
                                                    <div class="progress progress-xs">
