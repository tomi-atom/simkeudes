    ...
    <div class="col-md-12">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <a href="{{route('validasiperbaikanpengabdian.show', base64_encode(mt_rand(10,99).($proposalid*2+29)))}}" class="btn btn-default pull-left" name="awal" id="awal"><span class="fa fa-reply fa-fw"></span> Kembali</a>
            ...
            if (iRowCount > max+1) {
                ...
                swal({
                    ...
                    confirmButtonText: 'OK',
                        ...
                        if (isConfirm) {
                            window.location = "{{ route('validasiperbaikanpengabdian.show', base64_encode(mt_rand(10,99).($proposalid*2+29))) }}";
