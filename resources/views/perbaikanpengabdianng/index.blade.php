                ...
                <div class="panel-body">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <strong>Daftar Usul Perbaikan Pengabdian </strong> <small class="label label-success">{{$total}}</small>
                        </div>

                        <div class="panel-body">
                            @if($total == 0)
                                <div>Belum Ada Pengabdian Disetujui..</div>
                            @else
...
@section('script')
    <script type="text/javascript">
        ...
        function bacaProposalRinci(id) {
            window.location = "{{route('perbaikanpengabdianng.resume', '')}}/"+btoa(id);
        }

        function unduhProposal(id) {
            window.location = "{{route('perbaikanpengabdianng.unduh', '')}}/"+btoa(id)
        }
        ...
        function hapusProposal(id) {
            swal({
                ...
                cancelButtonText: 'Batal'
                    ...
                    if (isConfirm) {
                        $.ajax({
                            url  : "{{route('perbaikanpengabdianng.destroy','')}}/"+id,
                            type : "POST",
                            ...
                            success : function(data) {
                                ...
                                window.location = "{{route('perbaikanpengabdianng.index')}}";
                            },
                            error : function() {
                                swal(
                                    'Terjadi Kesalahan!',
        ...
        function setujuiProposal(id) {
            window.location = "{{route('perbaikanpengabdianng.setuju','')}}/"+btoa(id);
        }

        function bacaProposal(id) {
            window.location = "{{route('perbaikanpengabdianng.baca', '')}}/"+btoa(id);
        }
