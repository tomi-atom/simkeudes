...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-primary">
            ...
            <form action="{{ route('berkasseminar.update', $proposal->prosalid) }}" method="POST" class="form form-horizontal"  enctype="multipart/form-data" >
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="box-header">
                            ...
                            <h4 class="box-title">Unggah File Berkas Seminar Hasil</h4>
                        </div>

                        <div class="box-body">
                            <div class="row">
                            <p class="margin" align="justify"><b>BERKAS SEMINAR HASIL</b> <br><code>Berkas Seminar Hasil berupa file dokumen berbentuk PDF yang telah ditandatangani dengan ukuran (maks:2 MB) sesuai panduan.</code></p>
