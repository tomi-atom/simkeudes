...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-primary">
            <div class="panel-heading"><strong>Luaran Tambahan dan Capaian</strong> <div class="pull-right"><strong></strong></div></div>
...
<script type="text/javascript">
    function tampilLuaran() {
        ...
        $.ajax({
             url: "{{ route('luaranakhir.datatambahan') }}",
            method: "POST",
