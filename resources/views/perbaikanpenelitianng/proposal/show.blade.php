...
<div class="row">
    <div class="col-md-12">
        ...
        <form role="form" method="POST" action="{{route('perbaikanpenelitianng.proposal.update',[base64_encode(mt_rand(10,999)), base64_encode($proposal->id+81)])}}" name="formedit">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <a href="{{route('validasiperbaikanpenelitian.show', base64_encode(mt_rand(10,99).($proposal->id*2+29)))}}" class="btn btn-default pull-left" name="awal" id="awal"><span class="fa fa-reply fa-fw"></span> Kembali</a>
