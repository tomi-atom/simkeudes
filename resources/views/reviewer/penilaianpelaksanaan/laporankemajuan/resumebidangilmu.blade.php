                                ...
                                <form class="form-horizontal" data-toggle="validator" method="PUT">
                                    {{ csrf_field() }} {{ method_field('PUT') }}
                                        ...
                                        <div class="modal-header">
                                            ...
                                            <h3 class="modal-title"><a  href=" {{route('rn_laporankemajuan.resumeberkas',base64_encode(mt_rand(10,99). $prop->id))}}" class="btn btn-primary " title="Proposal"><i class="glyphicon glyphicon-file"></i>Lihat Laporan Kemajuan </a>                       
                                            </h3>
                                        </div>
                                        <br>
                                        <br>
