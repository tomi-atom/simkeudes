                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="">
                                ...
                                <br>
                                <form action="{{ route('r_anggaran.update', $penelitian->id) }}" method="POST" data-toggle="validator" class="form form-horizontal"  enctype="multipart/form-data" >
                                            ...
                                            swal({
                                                ...
                                                cancelButtonText: 'Tutup'
                                                    ...
                                                    if (isConfirm) {
                                                        ...
                                                        window.location = "{{route('r_anggaran.index', '')}}"
                                                    }
                                                }
                                            );
                                        </script>
                                ...
                                <div>
                                    ...
                                    @else
                                        <div class="panel-heading"><strong>Berkas Tidak Ditemukan: </strong></div>
                                    @endif
                                </div>
                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('r_anggaran.index') }}">
