            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading"><strong>Daftar Penggunaan Anggaran  </strong><div class="pull-right"><strong></strong></div></div>
                        <div class="panel-body">
                            <div class="row">
                ...
                <form id="update">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="tm_anggaran">Tanggal Mulai</label>
                            <input type="datetime-local" class="form-control tm_anggaran" name="tm_anggaran" placeholder="Tanggal Mulai" required>
                        </div>
                        <div class="form-group">
                            <label for="ta_anggaran">Tanggal Akhir</label>
                            <input type="datetime-local" class="form-control ta_anggaran" name="ta_anggaran" placeholder="Tanggal Akhir" required>
                        </div>
                    </div>
...
@section('script')
    <script type="text/javascript">
        ...
        function bacaProposalRinci(id) {
            window.location = "{{route('r_anggaran.resume', '')}}/"+btoa(id);
        }
        ...
        $(function () {
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            if (result.success) {
                                ...
                                let sesi = json.sesi;
                                $('.id').val(json.id);
                                $('.tm_anggaran').val(json.tm_anggaran);
                                $('.ta_anggaran').val(json.ta_anggaran);
            ...
            $(document).on('submit', '#modalEdit', function (e) {
                ...
                var data = {
                    ...
                    tm_anggaran: formData[1].value,
                    ta_anggaran: formData[2].value,
