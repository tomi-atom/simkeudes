            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading"><strong>Daftar Laporan Akhir  </strong><div class="pull-right"><strong></strong></div></div>
                        <div class="panel-body">
                            <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="filter_thn" id="filter_thn" class="form-control" required>
                                                ...
                                                @foreach($periode as $listperiode)
                                                    @if($listperiode->tm_laporanakhir == null && $listperiode->ta_laporanakhir== null)
                                                    ...
                                                    @else
                                                        <option value="{{ $listperiode->id }}">{{ $listperiode->tahun }} sesi {{ $listperiode->sesi }} - <span class="text text-green">Mulai : {{ $listperiode->tm_laporanakhir }} </span><span class="text text-green">- Akhir : {{ $listperiode->ta_laporanakhir }} -</span>@if($listperiode->aktif == 1) Aktif @else Tidak Aktif @endif </option>
            ...
            <div class="modal-content">
                ...
                <form id="update">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="tm_laporanakhir">Tanggal Mulai</label>
                            <input type="datetime-local" class="form-control tm_laporanakhir" name="tm_laporanakhir" placeholder="Tanggal Mulai" required>
                        </div>
                        <div class="form-group">
                            <label for="ta_laporanakhir">Tanggal Akhir</label>
                            <input type="datetime-local" class="form-control ta_laporanakhir" name="ta_laporanakhir" placeholder="Tanggal Akhir" required>
                        </div>
                    </div>
...
@section('script')
    <script type="text/javascript">
        ...
        function bacaProposalRinci(id) {
            window.location = "{{route('r_laporanakhir.resume', '')}}/"+btoa(id);
        }
        ...
        $(function () {
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            if (result.success) {
                                ...
                                let sesi = json.sesi;
                                $('.id').val(json.id);
                                $('.tm_laporanakhir').val(json.tm_laporanakhir);
                                $('.ta_laporanakhir').val(json.ta_laporanakhir);
            ...
            $(document).on('submit', '#modalEdit', function (e) {
                ...
                var data = {
                    ...
                    tm_laporanakhir: formData[1].value,
                    ta_laporanakhir: formData[2].value,

                };

                $.ajax({
                    url: "r_laporanakhir/" + id,
                    method: 'PUT',
                    data: data,
                    success: function (result) {
                        if (result.success) {
