                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="">
                                ...
                                <br>
                                <form action="{{ route('r_catatan.update', $penelitian->id) }}" method="POST" data-toggle="validator" class="form form-horizontal"  enctype="multipart/form-data" >
                                            ...
                                            swal({
                                                ...
                                                cancelButtonText: 'Tutup'
                                                    ...
                                                    if (isConfirm) {
                                                        ...
                                                        window.location = "{{route('r_catatan.index', '')}}"
                                                    }
                                                }
                                            );
                                        </script>
                                    ...
                                    <div class="panel-body">
                                        <div class="panel panel-default">
                                            ...
                                            <input type="hidden" name="prosalid" id="prosalid" value="{{$penelitian->id}}" readonly>
                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('r_catatan.index') }}">
