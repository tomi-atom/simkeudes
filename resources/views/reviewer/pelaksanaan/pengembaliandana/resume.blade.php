                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="">
                                ...
                                <br>
                                <form action="{{ route('r_pengembaliandana.update', $penelitian->id) }}" method="POST" data-toggle="validator" class="form form-horizontal"  enctype="multipart/form-data" >
                                            ...
                                            swal({
                                                ...
                                                cancelButtonText: 'Tutup'
                                                    ...
                                                    if (isConfirm) {
                                                        ...
                                                        window.location = "{{route('r_pengembaliandana.index', '')}}"
                                                    }
                                                }
                                            );
                                        </script>
                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('r_pengembaliandana.index') }}">
