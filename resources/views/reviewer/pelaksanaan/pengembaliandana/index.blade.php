            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading"><strong>Daftar Pengembalian Dana  </strong><div class="pull-right"><strong></strong></div></div>
                        <div class="panel-body">
                            <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="filter_thn" id="filter_thn" class="form-control" required>
                                                ...
                                                @foreach($periode as $listperiode)
                                                    @if($listperiode->tm_pengembaliandana == null && $listperiode->ta_pengembaliandana== null)
                                                    ...
                                                    @else
                                                        <option value="{{ $listperiode->id }}">{{ $listperiode->tahun }} sesi {{ $listperiode->sesi }} - <span class="text text-green">Mulai : {{ $listperiode->tm_pengembaliandana }} </span><span class="text text-green">- Akhir : {{ $listperiode->ta_pengembaliandana }} -</span>@if($listperiode->aktif == 1) Aktif @else Tidak Aktif @endif </option>
            ...
            <div class="modal-content">
                ...
                <form id="update">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="tm_pengembaliandana">Tanggal Mulai</label>
                            <input type="datetime-local" class="form-control tm_pengembaliandana" name="tm_pengembaliandana" placeholder="Tanggal Mulai" required>
                        </div>
                        <div class="form-group">
                            <label for="ta_pengembaliandana">Tanggal Akhir</label>
                            <input type="datetime-local" class="form-control ta_pengembaliandana" name="ta_pengembaliandana" placeholder="Tanggal Akhir" required>
                        </div>
                    </div>
...
@section('script')
    <script type="text/javascript">
        ...
        function bacaProposalRinci(id) {
            window.location = "{{route('r_pengembaliandana.resume', '')}}/"+btoa(id);
        }
        ...
        $(function () {
            ...
            function fill_datatable(filter_thn)
            {
                $('#mytable').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: 'r_pengembaliandana/get_data',
            ...
            $('#setwaktu').click(function(){
                ...
                if(filter_thn != '' )
                {
                    ...
                    $.ajax({
                        url: 'r_pengembaliandana/' + id + '/edit',
                        method: 'get',
                        success: function (result) {
                            ...
                            if (result.success) {
                                ...
                                let sesi = json.sesi;
                                $('.id').val(json.id);
                                $('.tm_pengembaliandana').val(json.tm_pengembaliandana);
                                $('.ta_pengembaliandana').val(json.ta_pengembaliandana);
            ...
            $(document).on('submit', '#modalEdit', function (e) {
                ...
                var data = {
                    ...
                    tm_pengembaliandana: formData[1].value,
                    ta_pengembaliandana: formData[2].value,

                };

                $.ajax({
                    url: "r_pengembaliandana/" + id,
                    method: 'PUT',
                    data: data,
                    success: function (result) {
                        if (result.success) {
