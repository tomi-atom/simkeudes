            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading"><strong>Daftar Tanggung Jawab Belanja  </strong><div class="pull-right"><strong></strong></div></div>
                        <div class="panel-body">
                            <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="filter_thn" id="filter_thn" class="form-control" required>
                                                ...
                                                @foreach($periode as $listperiode)
                                                    @if($listperiode->tm_tanggungjawab == null && $listperiode->ta_tanggungjawab== null)
                                                    ...
                                                    @else
                                                        <option value="{{ $listperiode->id }}">{{ $listperiode->tahun }} sesi {{ $listperiode->sesi }} - <span class="text text-green">Mulai : {{ $listperiode->tm_tanggungjawab }} </span><span class="text text-green">- Akhir : {{ $listperiode->ta_tanggungjawab }} -</span>@if($listperiode->aktif == 1) Aktif @else Tidak Aktif @endif </option>
            ...
            <div class="modal-content">
                ...
                <form id="update">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="tm_tanggungjawab">Tanggal Mulai</label>
                            <input type="datetime-local" class="form-control tm_tanggungjawab" name="tm_tanggungjawab" placeholder="Tanggal Mulai" required>
                        </div>
                        <div class="form-group">
                            <label for="ta_tanggungjawab">Tanggal Akhir</label>
                            <input type="datetime-local" class="form-control ta_tanggungjawab" name="ta_tanggungjawab" placeholder="Tanggal Akhir" required>
                        </div>
                    </div>
...
@section('script')
    <script type="text/javascript">
        ...
        function bacaProposalRinci(id) {
            window.location = "{{route('r_tanggungjawab.resume', '')}}/"+btoa(id);
        }
        ...
        $(function () {
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            if (result.success) {
                                ...
                                let sesi = json.sesi;
                                $('.id').val(json.id);
                                $('.tm_tanggungjawab').val(json.tm_tanggungjawab);
                                $('.ta_tanggungjawab').val(json.ta_tanggungjawab);
            ...
            $(document).on('submit', '#modalEdit', function (e) {
                ...
                var data = {
                    ...
                    tm_tanggungjawab: formData[1].value,
                    ta_tanggungjawab: formData[2].value,

                };

                $.ajax({
                    url: "r_tanggungjawab/" + id,
                    method: 'PUT',
                    data: data,
                    success: function (result) {
                        if (result.success) {
