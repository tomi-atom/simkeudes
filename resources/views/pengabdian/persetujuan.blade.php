        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-footer bg-white">
                ...
                {{ csrf_field() }} {{method_field('PATCH')}}
                    <div class="col-md-10">
                        <a href="{{route('pengabdian.response', base64_encode(('2'.$anggota->id)*$anggota->anggotaid) )}}" class="btn btn-danger pull-right" name="lanjut" id="lanjut"><span class="glyphicon glyphicon-thumbs-down"></span> TOLAK</a>
                        <a href="{{route('pengabdian.index')}}" class="btn btn-default pull-left" name="lanjut" id="lanjut"><span class="fa fa-reply fa-fw"></span> Kembali</a>  
                    </div>
                    <div class="col-md-2">
                        <a href="{{route('pengabdian.response', base64_encode(('1'.$anggota->id)*$anggota->anggotaid) )}}" class="btn btn-primary pull-right" name="lanjut" id="lanjut"><span class="glyphicon glyphicon-thumbs-up"></span> BERSEDIA</a> &nbsp;  
                    </div>
                </form>
                </div>
            </div> 
