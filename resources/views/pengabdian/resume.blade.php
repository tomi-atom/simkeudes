...
@section('title')
    Ringkasan Usulan Pengabdian Kepada Masyarakat
@endsection
    ...
    <div class="col-md-12">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">{{$prop->tktakhir ? $prop->tktakhir : '-'}}</td>
                ...
                @if ($stat == 1)
                <form class="form-horizontal" method="POST" action="{{ route('pengabdian.update', base64_encode($idprop)) }}">
                ...
                @else
                <form class="form-horizontal" method="POST" action="{{ route('pengabdian.index') }}">
