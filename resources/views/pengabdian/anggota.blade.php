        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="panel panel-default" id="personel" style="display: none;">
                    <div class="panel-body"><strong>Identitas Pengusul - Anggota Pelaksana Pengabdian Kepada Masyarakat Baru</strong></div>
                    ...
                    <div class="panel-footer">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                    ...
                                    <textarea class="form-control" rows="2" placeholder="Deskripsi tugas dalam pengabdian kepada masyarakat ..." name="judul" id="judul" required></textarea>
                ...
                <div class="panel panel-default" id="senarai">
                    <div class="panel-heading"><strong>Identitas Pengusul - Anggota Pelaksana Pengabdian Kepada Masyarakat </strong><font size="1"><span class="label label-danger"></span></font></div>
...
@include('pengabdian.formanggota')
@endsection
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#lanjut").click(function() {
            ...
            if (iRowCount > max+1) {
                ...
                window.location = "{{ route('pengabdian.subtansi', base64_encode($proposalid)) }}";
    ...
    function deleteData($id) {
        if (confirm("Apakah yakin keanggotaan peserta pegabdian akan dihapus?")) {
            $.ajax({
                url  : "../"+$id,
                type : "POST",
