    ...
    <div class="col-md-12">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('pengabdian.create') }}">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="panel panel-default">
                    <div class="panel-heading"><strong>Daftar Usul Pengabdian Kepada Masyarakat Baru</strong> <small class="label label-success">{{$total}}</small></div>
...
<script type="text/javascript">
    function bacaProposal(id) {
        ...
        window.location = "pengabdian/ringkasan/"+btoa(id)+"/baca";
    }

    function bacaProposalRinci(id) {
        //window.location = "{{ route('penelitian.baca', '+id+')}}";
        window.location = "{{route('pengabdian.resume', '')}}/"+btoa('2'+id);
    }

    function setujuiProposal(id) {
        window.location = "{{route('pengabdian.setuju','')}}/"+btoa(id);
    }

    function hapusProposal(id) {
        if (confirm("Apakah yakin proposal dari kegiatan ini akan dihapus?")) {
            window.location = "{{route('pengabdian.hapusproposal','')}}/"+id;
        }
    }
</script>
@endsection