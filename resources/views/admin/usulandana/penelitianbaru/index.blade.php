...
@section('title')
    Penelitian {{$periodeterbaru->tahun}} sesi {{$periodeterbaru->sesi}} Didanai
@endsection

@section('breadcrumb')
    @parent
    <li><a href="{{ route('usulandana.index') }}">Usulan</a></li>
           ...
           // fill_datatable();
            ...
            function fill_datatable(filter_skema = '')
            {
                $('#mytable').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: 'penelitianbarudana/get_data',
                ...
                swal({
                    ...
                    cancelButtonText: 'Batal'
                        ...
                        if (isConfirm) {
                            ...
                            $.ajax({
                                url: "{{route('penelitianbarudana.setuju', '')}}/"+id,
                                method: 'GET',
                                dataType: 'json',
                                data: {id:id,"_token": "{{ csrf_token() }}"},
