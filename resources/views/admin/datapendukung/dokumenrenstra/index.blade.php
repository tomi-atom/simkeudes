...
@section('breadcrumb')
    @parent
    <li><a href="{{ route('dp_dokumenrenstra.index') }}">Master</a></li>
    <li>Dokumen Renstra</li>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading"><strong>Daftar Dokumen Renstra  </strong><div class="pull-right"><strong></strong></div></div>
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <table id="mytable" class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="text-center" width="30%">Keterangan</th>
                ...
                <form id="update">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control batas" name="batas" placeholder="Batas" required>
                        </div>
                        <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#mytable').DataTable({
                processing: true,
                serverSide: true,
                ajax: 'dp_dokumenrenstra/get_data',
                columns: [{
                    data: 'rownum',
                    orderable: false,
                    searchable: false
            ...
            $(document).on('submit', '#modalAdd', function (e) {
                ...
                var data = {
                    ...
                    keterangan: formData[0].value,
                    jenis: formData[1].value,
                    upload: formData[2],
                };

                $.ajax({
                    url: "dp_dokumenrenstra",
                    method: 'post',
                    data: data,
                    success: function (result) {
                        if (result.success) {
