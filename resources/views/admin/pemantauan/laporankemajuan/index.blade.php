            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading"><strong>Daftar Laporan Kemajuan  </strong><div class="pull-right"><strong></strong></div></div>
                        <div class="panel-body">
                            <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="filter_thn" id="filter_thn" class="form-control" required>
                                                ...
                                                @foreach($periode as $listperiode)
                                                    @if($listperiode->tm_laporankemajuan == null && $listperiode->ta_laporankemajuan== null)
                                                    ...
                                                    @else
                                                        <option value="{{ $listperiode->id }}">{{ $listperiode->tahun }} sesi {{ $listperiode->sesi }} - @if($listperiode->jenis==1)<span>Penelitian</span> @else <span>Pengabdian </span> @endif - <span class="text text-green">Mulai : {{ $listperiode->tm_laporankemajuan }} </span><span class="text text-green">- Akhir : {{ $listperiode->ta_laporankemajuan }} -</span>@if($listperiode->aktif == 1) Aktif @else Tidak Aktif @endif </option>
...
@section('script')
    <script type="text/javascript">
        ...
        function bacaProposalRinci(id) {
            window.location = "{{route('p_laporankemajuan.resume', '')}}/"+btoa(id);
        }
        ...
        $(function () {
            ...
            function fill_datatable(filter_thn)
            {
                $('#mytable').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: 'p_laporankemajuan/get_data',
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            if (result.success) {
                                ...
                                let sesi = json.sesi;
                                $('.id').val(json.id);
                                $('.tm_laporankemajuan').val(json.tm_laporankemajuan);
                                $('.ta_laporankemajuan').val(json.ta_laporankemajuan);
