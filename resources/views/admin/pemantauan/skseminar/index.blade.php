            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading"><strong>Daftar SK Seminar Hasil  </strong><div class="pull-right"><strong></strong></div></div>
                        <div class="panel-body">
                            <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="filter_thn" id="filter_thn" class="form-control" required>
                                                ...
                                                @foreach($periode as $listperiode)
                                                    @if($listperiode->tm_skseminar == null && $listperiode->ta_skseminar== null)
                                                    ...
                                                    @else
                                                        <option value="{{ $listperiode->id }}">{{ $listperiode->tahun }} sesi {{ $listperiode->sesi }} - <span class="text text-green">Mulai : {{ $listperiode->tm_skseminar }} </span><span class="text text-green">- Akhir : {{ $listperiode->ta_skseminar }} -</span>@if($listperiode->aktif == 1) Aktif @else Tidak Aktif @endif </option>
            ...
            <div class="modal-content">
                ...
                <form id="update">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="tm_skseminar">Tanggal Mulai</label>
                            <input type="datetime-local" class="form-control tm_skseminar" name="tm_skseminar" placeholder="Tanggal Mulai" required>
                        </div>
                        <div class="form-group">
                            <label for="ta_skseminar">Tanggal Akhir</label>
                            <input type="datetime-local" class="form-control ta_skseminar" name="ta_skseminar" placeholder="Tanggal Akhir" required>
                        </div>
                    </div>
...
@section('script')
    <script type="text/javascript">
        ...
        function bacaProposalRinci(id) {
            window.location = "{{route('p_skseminar.resume', '')}}/"+btoa(id);
        }
        ...
        $(function () {
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            if (result.success) {
                                ...
                                let sesi = json.sesi;
                                $('.id').val(json.id);
                                $('.tm_skseminar').val(json.tm_skseminar);
                                $('.ta_skseminar').val(json.ta_skseminar);
            ...
            $(document).on('submit', '#modalEdit', function (e) {
                ...
                var data = {
                    ...
                    tm_skseminar: formData[1].value,
                    ta_skseminar: formData[2].value,
