            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading"><strong>Daftar Rancangan Pelaksanaan  </strong><div class="pull-right"><strong></strong></div></div>
                        <div class="panel-body">
                            <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="filter_thn" id="filter_thn" class="form-control" required>
                                                ...
                                                @foreach($periode as $listperiode)
                                                    @if($listperiode->tm_rancangan == null && $listperiode->ta_rancangan== null)
                                                    ...
                                                    @else
                                                        <option value="{{ $listperiode->id }}">{{ $listperiode->tahun }} sesi {{ $listperiode->sesi }} - <span class="text text-green">Mulai : {{ $listperiode->tm_rancangan }} </span><span class="text text-green">- Akhir : {{ $listperiode->ta_rancangan }} -</span>@if($listperiode->aktif == 1) Aktif @else Tidak Aktif @endif </option>
            ...
            <div class="modal-content">
                ...
                <form id="update">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="tm_rancangan">Tanggal Mulai</label>
                            <input type="datetime-local" class="form-control tm_rancangan" name="tm_rancangan" placeholder="Tanggal Mulai" required>
                        </div>
                        <div class="form-group">
                            <label for="ta_rancangan">Tanggal Akhir</label>
                            <input type="datetime-local" class="form-control ta_rancangan" name="ta_rancangan" placeholder="Tanggal Akhir" required>
                        </div>
                    </div>
...
@section('script')
    <script type="text/javascript">
        ...
        function bacaProposalRinci(id) {
            window.location = "{{route('p_rancangan.resume', '')}}/"+btoa(id);
        }
        ...
        $(function () {
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            if (result.success) {
                                ...
                                let sesi = json.sesi;
                                $('.id').val(json.id);
                                $('.tm_rancangan').val(json.tm_rancangan);
                                $('.ta_rancangan').val(json.ta_rancangan);
            ...
            $(document).on('submit', '#modalEdit', function (e) {
                ...
                var data = {
                    ...
                    tm_rancangan: formData[1].value,
                    ta_rancangan: formData[2].value,
