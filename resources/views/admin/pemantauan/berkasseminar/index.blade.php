            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading"><strong>Daftar Berkas Seminar  </strong><div class="pull-right"><strong></strong></div></div>
                        <div class="panel-body">
                            <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="filter_thn" id="filter_thn" class="form-control" required>
                                                ...
                                                @foreach($periode as $listperiode)
                                                    @if($listperiode->tm_berkasseminar == null && $listperiode->ta_berkasseminar== null)
                                                    ...
                                                    @else
                                                        <option value="{{ $listperiode->id }}">{{ $listperiode->tahun }} sesi {{ $listperiode->sesi }} - <span class="text text-green">Mulai : {{ $listperiode->tm_berkasseminar }} </span><span class="text text-green">- Akhir : {{ $listperiode->ta_berkasseminar }} -</span>@if($listperiode->aktif == 1) Aktif @else Tidak Aktif @endif </option>
            ...
            <div class="modal-content">
                ...
                <form id="update">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="tm_berkasseminar">Tanggal Mulai</label>
                            <input type="datetime-local" class="form-control tm_berkasseminar" name="tm_berkasseminar" placeholder="Tanggal Mulai" required>
                        </div>
                        <div class="form-group">
                            <label for="ta_berkasseminar">Tanggal Akhir</label>
                            <input type="datetime-local" class="form-control ta_berkasseminar" name="ta_berkasseminar" placeholder="Tanggal Akhir" required>
                        </div>
                    </div>
...
@section('script')
    <script type="text/javascript">
        ...
        function bacaProposalRinci(id) {
            window.location = "{{route('p_berkasseminar.resume', '')}}/"+btoa(id);
        }
        ...
        $(function () {
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            if (result.success) {
                                ...
                                let sesi = json.sesi;
                                $('.id').val(json.id);
                                $('.tm_berkasseminar').val(json.tm_berkasseminar);
                                $('.ta_berkasseminar').val(json.ta_berkasseminar);
            ...
            $(document).on('submit', '#modalEdit', function (e) {
                ...
                var data = {
                    ...
                    tm_berkasseminar: formData[1].value,
                    ta_berkasseminar: formData[2].value,

                };

                $.ajax({
                    url: "p_berkasseminar/" + id,
                    method: 'PUT',
                    data: data,
                    success: function (result) {
                        if (result.success) {
