    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form role="form" method="POST" enctype="multipart/form-data" action="{{route('profile.destroy',$dosen->id)}}">
                    ...
                    <div class="panel-footer">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 input-group input-group-sm">
                                <input id="nama" type="text" class="form-control" name="nama" value="{{$dosen->nama}}" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9 input-group input-group-sm">
                                <input id="nidn" type="text" class="form-control" name="nidn" value="{{$dosen->nidn}}" readonly>
                            </div>
                        </div>
