...
@section('title')
    Hasil Penilaian Luaran Lainnya
@endsection
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading"><strong>Hasil Penilaian Luaran Lainnya  </strong><div class="pull-right"><strong></strong></div></div>
                        <div class="panel-body">
                            <div class="row">
                            ...
                            <div class="table-responsive" >
                                <table id="mytable" class="table" hidden>
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="text-left" width="20%">Nilai Monev 1</th>
                                        <th scope="col" class="text-left" width="20%">Nilai Monev Hasil</th>
            ...
            function fill_datatable(filter_thn)
            {
                $('#mytable').DataTable({
                    ...
                    buttons : [
                                ...
                                {extend:'csv'},
                                {extend: 'pdf', title:'SIMPPM UNIVERSITAS RIAU : Luaran Lainnya '},
                                {extend: 'excel', title: 'SIMPPM UNIVERSITAS RIAU : Luaran Lainnya'},
                                {extend:'print',title: 'SIMPPM UNIVERSITAS RIAU : Luaran Lainnya'},
                    ],
                    ajax: {
                        url: 'hasilakhirluaran/get_data',
                    ...
                    {
                        data: 'nilaimonevhasil',

                    },
                    {
                            data: 'nilailuaranlainnya',
                    },
                    {
                            data: 'dana',
                    },
