...
@section('breadcrumb')
    @parent
    <li><a href="{{ route('penelitianng.index') }}">Pengabdian</a></li>
    <li>Pengusul</li>
    <li>Ringkasan</li>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                                ...
                                <form class="form-horizontal" data-toggle="validator" method="PUT">
                                    {{ csrf_field() }} {{ method_field('PUT') }}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <label>Potensi memberikan suatu nilai tambah (revenue generating) bagi masyarakat, baik dalam kegiatan ekonomi, kebijakan, perubahan perilaku (sosial)</label>
                                            </div>
                                            <div class="col-sm-1">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <label>Target luaran: submitted article dipublikasikan (Jurnal atau konferensi, media massa)</label>
                                            </div>
                                            <div class="col-sm-1">
                                                <label class="control-label col-sm-offset-2"> 15</label>
                                            </div>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="col-sm-12 input-group input-group-sm">
                                                    <select class="form-control" id="kriteria10" name="kriteria10" required>
                                                        ...
                                                        <option value="7"> > 10  Mahasiswa</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-sm-1">
                ...
                <div class="row">
                    ...
                    <br> Pangan di Wilayah Wetlands; 3. Pengelolaan Sumberdaya Alam dan Lingkungan di Wilayah Wetlands, 4. Pengembangan Pariwisata dan Ekonomi Kreatif di Wilayah Wetlands
...
@section('script')
    ...
    function getLatar() {
        var _token     = $('input[name = "_token"]').val();
         $.ajax({
           url: "{{ route('hasilreviewer.nilai', $nilai->id) }}",
            method: "POST",
            dataType: "json",
            data: {_token: _token},
            ...
            {
                if (result) {
                    $('#komentar').val(result[0]).attr("disabled", true);
                    $('#kriteria1').val(result[1]).attr("disabled", true);
                    $('#kriteria2').val(result[2]).attr("disabled", true);
                    $('#kriteria3').val(result[3]).attr("disabled", true);
                    $('#kriteria4').val(result[4]).attr("disabled", true);
                    $('#kriteria5').val(result[5]).attr("disabled", true);
                    $('#kriteria6').val(result[6]).attr("disabled", true);
                    $('#kriteria7').val(result[7]).attr("disabled", true);
                    $('#kriteria8').val(result[8]).attr("disabled", true);
                    $('#kriteria9').val(result[9]).attr("disabled", true);
                     $('#kriteria10').val(result[10]).attr("disabled", true);
                    ...
                    $('#rekomdana').val(result[23]).attr("disabled", true);
