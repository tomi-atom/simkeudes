                                ...
                                <form class="form-horizontal" data-toggle="validator" method="PUT">
                                    {{ csrf_field() }} {{ method_field('PUT') }}
                                            ...
                                            <div class="col-sm-2">
                                                <div class="col-sm-12 input-group input-group-sm">
                                                     <select class="form-control" id="kriteria8" name="kriteria8" required>
                                                        <option value=""> -  </option>
                                                        <option value="1"> Tidak Ada  </option>
                                                        <option value="5">Ada mitra, tapi bukan mitra produktif </option>
                                                        <option value="7"> Ada mitra produktif</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-sm-1">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="col-sm-12 input-group input-group-sm">
                                                    <select class="form-control" id="kriteria11" name="kriteria11" required>
                                                        <option value=""> -  </option>
                                            ...
                                            <div class="col-sm-1">
                                                <div class="col-sm-12 input-group input-group-sm">
                                                    <input type="text" class="form-control" value="0" name="nilai11" id="nilai11" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <br>
