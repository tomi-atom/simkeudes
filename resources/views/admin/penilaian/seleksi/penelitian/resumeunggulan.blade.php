            ...
            <div class="panel-body">
                                ...
                                <form class="form-horizontal" data-toggle="validator" method="PUT">
                                    {{ csrf_field() }} {{ method_field('PUT') }}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <label>Proyeksi/Potensi luaran tambahan penelitian: Teknologi Tepat Guna/Buku ISBN/Prototype</label>
                                            </div>
                                            <div class="col-sm-1">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <br>- Kemutakhiran literatur (5 tahun terakhir): Tidak ada pustaka primer (1 = Buruk); Pustaka tergolong primer dan mutakhir <50% (3 = Kurang); Pustaka tergolong primer dan mutakhir sejumlah 51-80% (5 = Cukup); Pustaka tergolong primer dan mutakhir >80% (7 = Sangat baik)
                        <br>- Tema Riset: Mohon dilingkari Tema Unggulan UNRI: 1. Pengembangan Wilayah Wetlands; 2. Pengembangan Perkebunan dan Peningkatan Ketahanan Pangan di Wilayah Wetlands; 3. Pengelolaan Sumberdaya Alam dan Lingkungan di Wilayah Wetlands,  4. Pengembangan Pariwisata dan Ekonomi Kreatif di Wilayah Wetlands.</h6>
                    </div>
                </div>
                <br>
...
@section('script')
    ...
    function lanjutSubtansi() {
        ...
        if(kriteria1 != "" && kriteria2 != "" && kriteria3 != "" && kriteria4 != "" && kriteria5 != "" && kriteria6 != "" && kriteria7 != "" && kriteria8 != "" && kriteria9 != ""  ){
                      ...
                      swal(
                        ...
                        'error'
                           ...
                           $.ajax({
                            ...
                            nilai1: nilai1,nilai2: nilai2,nilai3: nilai3,nilai4: nilai4,nilai5: nilai5,nilai6: nilai6,nilai7: nilai7,nilai8: nilai8,nilai9: nilai9,rekomdana: rekomdana,komentar: komentar,kelayakan: kelayakan,  _token: _token},
                            success: function(result)
                            {
                                swal({
                                    title: 'Selamat!',
