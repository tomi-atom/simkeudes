            ...
            function fill_datatable(filter_thn)
            {
                $('#mytable').DataTable({
                    ...
                    buttons : [
                                ...
                                {extend:'csv'},
                                {extend: 'pdf', title:'SIMPPM UNIVERSITAS RIAU : Hasil Monev '},
                                {extend: 'excel', title: 'SIMPPM UNIVERSITAS RIAU : Hasil Monev'},
                                {extend:'print',title: 'SIMPPM UNIVERSITAS RIAU : Hasil Monev'},
                    ],
                    ajax: {
