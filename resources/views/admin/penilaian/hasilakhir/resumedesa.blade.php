...
@section('breadcrumb')
    @parent
    <li><a href="{{ route('hasilakhir.index') }}">Monev Hasil</a></li>
    ...
    <div class="col-md-12">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('hasilakhir.index') }}">
...
@section('script')
    <script type="text/javascript">
     function resumeberkas(id) {
        window.location = "{{route('hasilakhir.resume', '')}}/"+id;
    }
    function getLatar() {
        var _token     = $('input[name = "_token"]').val();
         $.ajax({
            url: "{{ route('hasilakhir.nilai', $prop->id) }}",
            method: "POST",
            dataType: "json",
            data: {_token: _token},
