...
@section('breadcrumb')
    @parent
    <li><a href="{{ route('user.index') }}">Master</a></li>
    <li>List User</li>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading"><strong>Daftar List User  </strong><div class="pull-right"><strong></strong></div></div>
                        <div class="panel-body">
                            <div class="box-header with-border">
                                <button onclick="tambahUser()" class="btn btn-primary pull-right create"><i class="glyphicon glyphicon-plus"></i> Tambah</button>
                            </div>
                            <br>
                            <div class="table-responsive">
                                <table id="mytable" class="table">
                                    ...
                                    <tr>
                                        <th scope="col" class="text-left" width="4%">No. Anggota</th>
                                        <th scope="col" class="text-center" width="10%">Nama</th>
                                        <th scope="col" class="text-center" width="10%">KTP</th>
                                        <th scope="col" class="text-left" width="10%">KK</th>
                                        <th scope="col" class="text-left" width="10%">Email</th>
                                        <th scope="col" class="text-left" width="10%">Alamat</th>
                                        <th scope="col" class="text-left" width="10%">Kelamin</th>
                                        <th scope="col" class="text-left" width="10%">Tanggal Lahir</th>
                                        <th scope="col" class="text-left" width="10%">SHDK</th>
                                        <th scope="col" class="text-left" width="10%">Agama</th>
                                        <th scope="col" class="text-left" width="10%">Pendidikan</th>
                                        <th scope="col" class="text-left" width="10%">Ibu</th>
        ...
        $(function () {
            $('#mytable').DataTable({
                ...
                buttons : [
                            ...
                            {extend:'csv'},
                            {extend: 'excel', title: 'SIMKEUDES'},

                ],
                ajax: 'user_data/get_data',
                columns: [
                    {
                        data: 'no_anggota',
                        name:'no_anggota'
