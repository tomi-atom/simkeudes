...
class PengembalianDanaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pelaksanaan.pengembaliandana.index', compact('person', 'peneliti','waktu', 'periode','periodeterbaru', 'proposal', 'total','ketua','peserta','member', 'status', 'minat','upload'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('pelaksanaan.pengembaliandana.create', compact('person', 'peneliti', 'program', 'periode'));
    }
    ...
    public function edit($id)
    {
        ...
        if ($proposal) {
            ...
            return view ('pelaksanaan.pengembaliandana.unggahan', compact('person','proposal'));
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($proposal) {
            ...
            $subtansi->save();
            //$proposal->update();
            return Redirect::route('pengembaliandana.index', base64_encode(mt_rand(10,99).($idprop*2+29)));
        }
    }
