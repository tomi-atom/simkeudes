...
class PenggunaanAnggaranController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pelaksanaan.penggunaananggaran.index', compact('person', 'peneliti','waktu', 'periode','periodeterbaru', 'proposal', 'total','ketua','peserta','member', 'status', 'minat','upload'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('pelaksanaan.penggunaananggaran.create', compact('person', 'peneliti', 'program', 'periode'));
    }
    ...
    public function edit($id)
    {
        ...
        if ($proposal) {
            ...
            return view ('pelaksanaan.penggunaananggaran.unggahan', compact('person','proposal'));
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($proposal) {
            ...
            $subtansi = new PenggunaanAnggaran();
            ...
            $subtansi->save();
            //$proposal->update();
            return Redirect::route('penggunaananggaran.index', base64_encode(mt_rand(10,99).($idprop*2+29)));
        }
    }
