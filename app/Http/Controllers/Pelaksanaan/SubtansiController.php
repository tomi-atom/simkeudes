...
class SubtansiController extends Controller
{
    ...
    public function index($id)
    {
        ...
        return view('pelaksanaan.subtansi.index', compact('person','proposalid','prosalid','idtemp'));
    }
    ...
    public function store($id, Request $request)
    {
        ...
        if ($request->get('ringkasan')) {
            ...
            $subtansi->prosalid = $id;
            $subtansi->status  = 4;
            $subtansi->upload  = $request->get('ringkasan');

            $subtansi->save();
             return Redirect::route('catatanharian.index')->withInput()->withErrors(array('success' => 'success'));
    ...
    public function show($id)
    {
        ...
        return view('pelaksanaan.subtansi.show', compact('person','proposalid','prosalid','idtemp'));
