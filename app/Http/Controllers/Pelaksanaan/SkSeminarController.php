...
class SkSeminarController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pelaksanaan.skseminar.index', compact('person', 'peneliti','waktu', 'periode','periodeterbaru', 'proposal', 'total','ketua','peserta','member', 'status', 'minat','upload'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('pelaksanaan.skseminar.create', compact('person', 'peneliti', 'program', 'periode'));
    }
    ...
    public function edit($id)
    {
        ...
        if ($proposal) {
            ...
            return view ('pelaksanaan.skseminar.unggahan', compact('person','proposal'));
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($proposal) {
            ...
            $subtansi->save();
            //$proposal->update();
            return Redirect::route('skseminar.index', base64_encode(mt_rand(10,99).($idprop*2+29)));
        }
    }
