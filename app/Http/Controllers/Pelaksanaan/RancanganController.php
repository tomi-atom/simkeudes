...
class RancanganController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pelaksanaan.rancangan.index', compact('person', 'peneliti', 'periode','periodeterbaru','waktu', 'proposal', 'total','ketua','peserta','member', 'status', 'minat','upload'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('pelaksanaan.rancangan.create', compact('person', 'peneliti', 'program', 'periode'));
    }
    ...
    public function edit($id)
    {
        ...
        if ($proposal) {
            ...
            return view ('pelaksanaan.rancangan.unggahan', compact('person','proposal'));
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($proposal) {
            ...
            $subtansi = new RancanganPenelitian();
            ...
            $subtansi->save();
            //$proposal->update();
            return Redirect::route('rancangan.index', base64_encode(mt_rand(10,99).($idprop*2+29)));
        }
    }
