...
class BerkasSeminarController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pelaksanaan.berkasseminar.index', compact('person', 'peneliti', 'periode','periodeterbaru', 'waktu', 'proposal', 'total','ketua','peserta','member', 'status', 'minat','upload'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('pelaksanaan.berkasseminar.create', compact('person', 'peneliti', 'program', 'periode'));
    }
    ...
    public function edit($id)
    {
        ...
        if ($proposal) {
            ...
            return view ('pelaksanaan.berkasseminar.unggahan', compact('person','proposal'));
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($proposal) {
            ...
            $subtansi->save();
            //$proposal->update();
            return Redirect::route('berkasseminar.index', base64_encode(mt_rand(10,99).($idprop*2+29)));
        }
    }
