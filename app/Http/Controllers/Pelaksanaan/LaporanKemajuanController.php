...
class LaporanKemajuanController extends Controller
{
    ...
    public function index()
    {
        ...
        $proposal = Proposal::select('judul','idprogram','idskema','periodeusul','idfokus','aktif','thnkerja','tb_laporan_kemajuan.status','tb_penelitian.prosalid','jenis','upload')
        ...
        return view('pelaksanaan.laporankemajuan.index', compact('person', 'peneliti','waktu', 'periode','periodeterbaru', 'proposal', 'total','ketua','peserta','member', 'status', 'minat','upload'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('pelaksanaan.laporankemajuan.create', compact('person', 'peneliti', 'program', 'periode'));
    }
    ...
    public function edit($id)
    {
        ...
        if ($proposal) {
            ...
            return view ('pelaksanaan.laporankemajuan.unggahan', compact('person','proposal'));
        }
    }
        ...
        $idprop = $id;
         ...
         $proposal = Proposal::find($idprop);
            if ($proposal) {
                ...
                $subtansi->save();
                //$proposal->update();
                return Redirect::route('laporankemajuan.index', base64_encode(mt_rand(10,99).($idprop*2+29)));
            } 
