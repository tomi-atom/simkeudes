...
class Penilaian2LaporanKemajuanController extends Controller
{
    ...
    public function index()
    {
        ...
        $person = Penilaian2LaporanKemajuanController::countPersonil();
    ...
    {
        $nilai = Nilai2LaporanKemajuan::where('prosalid', $id)->where('iddosen',Auth::user()->id)->first();
