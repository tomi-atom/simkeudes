...
class PengabdianngPerbaikanController extends Controller
{
    ...
    {
        $person = PengabdianngPerbaikanController::countPersonil();
      ...
      //  $periode  = Periode::where('aktif', '1')->where('jenis','2')->orderBy('tahun', 'desc')->orderBy('sesi', 'desc')->get();
        ...
        return view('pengabdianngperbaikan.index', compact('person', 'peneliti', 'periode', 'proposal', 'total','ketua','peserta','member', 'status', 'minat', 'waktu'));
    }
