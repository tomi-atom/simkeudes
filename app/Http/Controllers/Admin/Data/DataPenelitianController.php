...
class DataPenelitianController extends Controller
{
    ...
    public function index()
    {
        ...
        $person = DataPenelitianController::countPersonil();
        ...
        return view('admin.datapenelitian.index', compact('skema','person', 'peneliti','reviewerpenelitian','reviewerpengabdian', 'periode','aperiode', 'proposal', 'total','ketua','peserta','member', 'status', 'minat'));
    }
