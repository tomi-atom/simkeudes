...
class PenelitianBaruController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.usulandana.penelitianbaru.index', compact('skema','person', 'peneliti', 'periode','periodeterbaru', 'proposal', 'total','ketua','peserta','member', 'status', 'minat'));
    ...
    public function edit($id)
    {
        try
        {
            ...
            $penelitian = Pengabdian::where('prosalid',$id)->first();
