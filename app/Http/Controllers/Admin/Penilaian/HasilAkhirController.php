...
class HasilAkhirController extends Controller
{
    ...
    public function index()
    {
        ...
        $person = HasilAkhirController::countPersonil();
        ...
        return view('admin.penilaian.hasilakhir.index', compact('skema','person', 'peneliti','reviewerpenelitian','reviewerpengabdian', 'periode','aperiode', 'proposal', 'total','ketua','peserta','member', 'status', 'minat'));
    }
