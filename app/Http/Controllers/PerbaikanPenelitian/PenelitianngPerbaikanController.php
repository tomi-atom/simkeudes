...
class PenelitianngPerbaikanController extends Controller
{
    ...
    {
        $person = PenelitianngPerbaikanController::countPersonil();
      ...
      //  $periode  = Periode::where('aktif', '1')->where('jenis','1')->orderBy('tahun', 'desc')->orderBy('sesi', 'desc')->get();
        ...
        return view('penelitianngperbaikan.index', compact('person', 'peneliti', 'periode', 'proposal', 'total','ketua','peserta','member', 'status', 'minat', 'waktu'));
    }
